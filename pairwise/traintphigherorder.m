...
load('./videoset/result/geometrictppairwise.mat');
minerror=1;
diary('tponlyhigherordern.txt')
diary on;
choice1=1:4;
choice2=-6:-2;
finalchoice=[];
...
parfor iter=1:100
    ...
    parahigher3=exp(fullchoice(iter,3));
...
%                         error=higherorder(minpara(1),minpara(2),10^-4,10^-4,parahigher1,parahigher2,parahigher3,parahigher4,parahigher5,0);
                        error=higherorder(minpara(1),minpara(2),10^-4,10^-4,parahigher1,parahigher2,parahigher5,0);
...
save('./videoset/result/errorfortphigherorder.mat','minerror');
...
diary off;
load('./videoset/result/geometrictphigher.mat');
...
%     error1=higherorder(minpara(1),minpara(2),minparabe(1),minparabe(2),minparahigher(1),minparahigher(2),minparahigher(3),minparahigher(4),minparahigher(5),0);
       error1=higherorder(minpara(1),minpara(2),minparabe(1),minparabe(2),minparahigher(1),minparahigher(2),minparahigher(3),0);
...
save('./videoset/result/errorfortphigherorderandpairwise.mat','minerror');
